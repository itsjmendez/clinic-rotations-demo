...
Shift: ${rotation.springClinic.shift}
  ...
  return (
    <Card>
      ...
      <CardContent>
        <p><strong>Student ID:</strong> {rotation.studentId}</p>
        <p><strong>Email:</strong> {rotation.studentEmail}</p>
        <h3 className="font-semibold mt-4">Fall Rotation</h3>
        <p><strong>Clinic:</strong> {rotation.fallClinic.name}</p>
        <p><strong>Clinic ID:</strong> {rotation.fallClinic.id}</p>
        <p><strong>Address:</strong> {rotation.fallClinic.address}</p>
        <p><strong>Shift:</strong> {rotation.fallClinic.shift}</p>
        <h3 className="font-semibold mt-4">Spring Rotation</h3>
        <p><strong>Clinic:</strong> {rotation.springClinic.name}</p>
        <p><strong>Clinic ID:</strong> {rotation.springClinic.id}</p>
        <p><strong>Address:</strong> {rotation.springClinic.address}</p>
        <p><strong>Shift:</strong> {rotation.springClinic.shift}</p>
      </CardContent>
      <CardFooter>
